...
```bash
python tarea_arbol_binario_metodos/main.py
```

También se puede ejecutar solamente la práctica de expresiones:

```bash
python tarea_arbol_binario_metodos/arbol_expresiones.py
```
...
```bash
python -m unittest tarea_arbol_binario_metodos.tests -v
```
